...
-- @notes @corpus_k is 3-10 because that is what all 18 rewritable sites in the enabled GAMMA corpus are: short UI string builders (agent-I039). The transform is a big win at K in the hundreds and a regression where it actually runs, which is why the promotion out of --experimental was pruned.
